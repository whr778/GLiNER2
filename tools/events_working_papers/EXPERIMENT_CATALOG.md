...
| 2026-09-19 | **Data** | cmnee + duee entity annotation | buy the entity gold that lifts option 2 past its 35.7% ceiling | Batch API | **RUNNING** — 26,667 documents; option 4's derived labels cannot substitute, being role-derived and circular | ~$7 | `OPTION_2_TYPED_ROLE_CONSTRAINTS.md` |
